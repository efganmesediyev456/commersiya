            ...
            <div class="col-md-6 offset-md-3">
                <form class="user" method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="tab-content pt-2 pl-1" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show {{ ($locale->code == 'az') ? 'active': '' }}"
                                ...
                                <div class="form-group">
                                    <input id="title" type="text"
                                           ...
                                           name="name[{{ $locale->code }}]" value="{{ old('') }}"
                        ...
                        <div class="form-group">
                            <input id="quantity" type="text" class="form-control @error('image') is-invalid @enderror"
                                   name="quantity"
                                   placeholder="{{ __('Quantitiy') }}">
                            @error('quantity')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
